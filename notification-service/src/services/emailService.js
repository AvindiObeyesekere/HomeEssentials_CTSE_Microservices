    ...
    html: `
      <div style="margin:0;padding:24px;background:${brandPalette.surface};font-family:Arial,Helvetica,sans-serif;color:${brandPalette.text};">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;margin:0 auto;background:#ffffff;border-radius:14px;overflow:hidden;border:1px solid #E2E8F0;">
          <tr>
            <td style="padding:0;">
              <div style="background:#DC2626;color:#ffffff;text-align:center;font-size:18px;font-weight:700;padding:10px 14px;">! Low Stock Alert</div>
            </td>
          </tr>
          <tr>
            <td style="padding:24px 24px 10px 24px;">
              <h2 style="margin:0 0 10px 0;color:${brandPalette.primary};font-size:24px;line-height:1.3;">Inventory Threshold Reached</h2>
              <p style="margin:0;color:${brandPalette.muted};font-size:15px;line-height:1.6;">Hi Team,</p>
            </td>
          </tr>
          <tr>
            <td style="padding:12px 24px 24px 24px;">
              <div style="background:#FEF2F2;border-left:4px solid #DC2626;padding:14px 16px;border-radius:8px;color:${brandPalette.text};font-size:14px;line-height:1.7;">
                <p style="margin:0 0 10px 0;"><strong>${productName || 'Product'}</strong> has reached the low stock threshold.</p>
                <p style="margin:0 0 6px 0;"><strong>Current Stock:</strong> ${currentStock ?? 'N/A'}</p>
                <p style="margin:0 0 12px 0;"><strong>Low Stock Threshold:</strong> ${threshold ?? 'N/A'}</p>
                <div style="text-align:center;margin-top:14px;">
                  <span style="display:inline-block;background:#2563EB;color:#ffffff;padding:10px 18px;border-radius:8px;font-size:14px;font-weight:600;">Alert Retailers</span>
                </div>
              </div>
            </td>
          </tr>
