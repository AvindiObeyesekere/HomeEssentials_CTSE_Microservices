      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea className={field('description')} name="description" value={form.description} onChange={handleChange} rows={3} required minLength={10} maxLength={1000} placeholder="Describe the product in detailâ€¦" />
          ...
          <div className="flex gap-3 pt-2">
            ...
            >
              ...
              ) : isEdit ? 'âœ… Update Product' : 'âœ… Create Product'}
            </button>
