...
export default function PaymentsPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 text-center px-4">
      ...
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Payments Service</h2>
        <p className="text-gray-500 max-w-md">
          The Payment microservice is under development. It will handle transaction processing,
          refunds, payment history, and integration with the Orders service.
        </p>
      </div>
      <div className="flex items-center gap-2 bg-green-50 border border-green-200 text-green-700 text-sm px-4 py-2.5 rounded-xl">
        <Clock size={15} />
        <span>Expected on port <strong>3005</strong> — Not yet implemented</span>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-xl w-full mt-2">
        {['Process Payment', 'Refunds', 'Payment History'].map((f) => (
